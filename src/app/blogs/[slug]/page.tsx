        ...
        <div className="container mx-auto p-6">
          ...
          <div className="prose prose-lg p-6 text-gray-800 dark:text-gray-200 rounded-xl shadow-lg">
            <div
              ...
              className="
    [&>h1]:text-5xl [&>h1]:font-bold [&>h1]:mt-6 [&>h1]:mb-4 [&>h1]:text-gray-900 dark:[&>h1]:text-gray-100
    [&>h2]:text-4xl [&>h2]:font-semibold [&>h2]:mt-6 [&>h2]:mb-3 [&>h2]:text-gray-800 dark:[&>h2]:text-gray-200
    [&>h3]:text-4xl [&>h3]:font-bold [&>h3]:mt-5 [&>h3]:mb-3 [&>h3]:text-gray-700 dark:[&>h3]:text-gray-300
    [&>p]:text-xl [&>p]:leading-relaxed [&>p]:mt-3 [&>p]:mb-4 [&>p]:text-gray-600 dark:[&>p]:text-gray-400

[&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mt-3 [&>ul]:mb-4 [&>ul]:text-lg
    [&>ol]:list-decimal [&>ol]:pl-6 [&>ol]:mt-3 [&>ol]:mb-4 [&>ol]:text-lg
    [&>li]:text-lg [&>li]:text-gray-700 dark:[&>li]:text-gray-300 [&>li]:mt-1 [&>li]:mb-1
    ...
    [&>figcaption]:text-xl [&>figcaption]:text-gray-500 dark:[&>figcaption]:text-gray-400 [&>figcaption]:mt-2
  "
            />
          </div>
          </TracingBeam>
